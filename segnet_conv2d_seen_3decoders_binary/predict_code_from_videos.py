...
width = 68
n_ops = 2
segnet_model = load_model('/mnt/d/IISc_Internship/segnet_conv2d_seen_3decoders_binary/M3_model_best.weights')
...
for sub in range(len(subs)):
	vid = glob.glob( '/mnt/d/IISc_Internship/Videos/M3/M3_'+Test_Vid[v]+'.avi'  )
	vid.sort()
